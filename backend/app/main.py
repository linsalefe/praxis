...
from app.routers import assinatura, auth, biblioteca, consentimentos, documentos, equipe, evolucoes, exportacao, financeiro, inicio, instrumentos as instrumentos_router, longitudinal, pacientes, preparacao, risco, scribe, sessoes, sofia, supervisao
