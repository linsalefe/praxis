...
from app.routers import auth, consentimentos, documentos, evolucoes, inicio, instrumentos as instrumentos_router, pacientes, preparacao, scribe, sessoes, sofia, supervisao
